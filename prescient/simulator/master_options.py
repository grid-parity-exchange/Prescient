...
def _construct_inner_options_parser():
    ...
    populator_options = parser.add_argument_group("Populator Options")
    input_simulation_options = parser.add_argument_group("InputSimulation Options")
    solver_simulation_options = parser.add_argument_group("SolverSimulation Options")
    output_simulation_options = parser.add_argument_group("OutputSimulation Options")
    extension_options = parser.add_argument_group("Extension Options")
    other_simulation_options = parser.add_argument_group("OtherSimulation Options")
...
##########################
    ...
    populator_options.add_argument("--start-date",
    ...
    populator_options.add_argument("--num-days",
    ...
    populator_options.add_argument("--output-directory",
...
# # PRESCIENT_INPUT_OPTIONS
    ...
    extension_options.add_argument('--plugin',
    ...
    input_simulation_options.add_argument('--simulator-plugin',
    ...
    input_simulation_options.add_argument('--deterministic-ruc-solver-plugin',
    ...
    input_simulation_options.add_argument('--run-ruc-with-next-day-data',
    ...
    input_simulation_options.add_argument('--run-sced-with-persistent-forecast-errors',
    ...
    input_simulation_options.add_argument('--ruc-prescience-hour',
    ...
    input_simulation_options.add_argument('--ruc-execution-hour',
    ...
    input_simulation_options.add_argument('--ruc-every-hours',
    ...
    populator_options.add_argument("--ruc-horizon",
    ...
    input_simulation_options.add_argument('--sced-horizon',
    ...
    input_simulation_options.add_argument('--sced-frequency-minutes',
    ...
    input_simulation_options.add_argument("--enforce-sced-shutdown-ramprate",
    ...
    input_simulation_options.add_argument("--no-startup-shutdown-curves",
    ...
    input_simulation_options.add_argument("--simulate-out-of-sample",
    ...
    input_simulation_options.add_argument("--reserve-factor",
    ...
    input_simulation_options.add_argument('--compute-market-settlements',
    ...
    input_simulation_options.add_argument('--price-threshold',
    ...
    input_simulation_options.add_argument('--reserve-price-threshold',
...
# # PRESCIENT_SOLVER_OPTIONS
    ...
    solver_simulation_options.add_argument('--sced-solver',
    ...
    solver_simulation_options.add_argument('--deterministic-ruc-solver',
    ...
    solver_simulation_options.add_argument("--sced-solver-options",
    ...
    solver_simulation_options.add_argument("--deterministic-ruc-solver-options",
    ...
    solver_simulation_options.add_argument("--stochastic-ruc-ef-solver-options",
    ...
    solver_simulation_options.add_argument('--write-deterministic-ruc-instances',
                                         help='Write all individual SCED instances.',
                                         action='store_true',
                                         dest='write_deterministic_ruc_instances',
                                         default=False)

    solver_simulation_options.add_argument('--write-sced-instances',
                                         help='Write all individual SCED instances.',
                                         action='store_true',
                                         dest='write_sced_instances',
                                         default=False)

    solver_simulation_options.add_argument('--print-sced',
                                         help='Print results from SCED solves.',
                                         action='store_true',
                                         dest='print_sced',
                                         default=False)

    solver_simulation_options.add_argument('--ruc-mipgap',
    ...
    solver_simulation_options.add_argument('--symbolic-solver-labels',
    ...
    solver_simulation_options.add_argument('--enable-quick-start-generator-commitment',
                                         help="Allows quick start generators to be committed if load shedding occurs",
                                         action="store_true",
                                         dest="enable_quick_start_generator_commitment",
                                         default=False)

    solver_simulation_options.add_argument('--day-ahead-pricing',
...
# # PRESCIENT_OUTPUT_OPTIONS
    ...
    output_simulation_options.add_argument('--output-ruc-initial-conditions',
    ...
    output_simulation_options.add_argument('--output-ruc-solutions',
    ...
    output_simulation_options.add_argument('--output-sced-initial-conditions',
    ...
    output_simulation_options.add_argument('--output-solver-logs',
                                         help="Output solver logs during execution.",
                                         action='store_true',
                                         dest='output_solver_logs',
                                         default=False)

    output_simulation_options.add_argument('--output-max-decimal-places',
    ...
    output_simulation_options.add_argument('--disable-stackgraphs',
...
# # PRESCIENT_OTHER_OPTIONS
    ...
    other_simulation_options.add_argument('--profile',
    ...
    other_simulation_options.add_argument('--traceback',
