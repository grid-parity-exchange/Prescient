...
print('loading latorre base model')    
multistage=False
useLastCommitments=False
...
if multistage:
    ...
    def compute_decommitment_fixed_cost_rule(m, g,s): 
        return m.MinimumProductionCost[g]
    model.deCommitmentFixedCost = Param(model.ThermalGenerators,model.StageSet, within=NonNegativeReals, initialize=compute_decommitment_fixed_cost_rule) # units are $.
