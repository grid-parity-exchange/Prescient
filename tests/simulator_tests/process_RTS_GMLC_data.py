...
def create_timeseries():
    ...
    path = os.path.normpath(os.path.join(this_path,"../../downloads/RTS-GMLC/RTS_Data/timeseries_data_files/"))
    source_path = os.path.normpath(os.path.join(this_path, "../../downloads/RTS-GMLC/RTS_Data/SourceData/"))
    write_path = os.path.normpath(os.path.join(this_path,"timeseries_data_files/"))
